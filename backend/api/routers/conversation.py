...
async def create_conversation(
    ...
    return ApiResponse(data=await service.to_response_dict(conversation))
...
async def list_conversations(
    ...
    paginated = PaginatedResponse.create(
        items=[await service.to_response_dict(item) for item in conversations],
        total=total,
        page=page,
        size=size,
    )
...
async def get_conversation(
    ...
    conv_dict.update(await service.to_response_dict(conversation))
